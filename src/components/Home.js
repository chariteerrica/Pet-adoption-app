  ...
  return (
    <div style={wrapperStyle}>
      <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem', width: '100%', maxWidth: '900px' }}>
        ...
        {/* Welcome */}
        <PageCard>
          <h1 style={headingStyle}>🐾 Welcome to Pet Adopter Vetting App!</h1>
        ...
        <div style={imageContainerStyle}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem', marginTop: '2rem' }}>
            ...
            <StyledButton to="/applications">📝 Applications</StyledButton>
            <StyledButton to="/profile">👤 My Profile</StyledButton>
          </div>
        </PageCard>
        ...
        <div style={buttonContainerStyle}>
          <StyledButton to="/pets">🐶 View Pets</StyledButton>
        </div>
        </PageCard>
